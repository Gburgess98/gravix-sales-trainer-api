...
async function postToSignedUrlWithProgress(signedUrl, file, authToken, onProgress) {
 ...
 */
export async function uploadCall(file, opts) {
    ...
    const { url: signedUrl, path } = initJson;
